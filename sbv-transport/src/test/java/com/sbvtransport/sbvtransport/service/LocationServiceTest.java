...
public class LocationServiceTest {
  ...
  public void createTest() {
    ...
    assertThat(location.getLocation_name()).isEqualTo(locationDTO.getLocation_name());
    assertThat(location.getAddress()).isEqualTo(locationDTO.getAddress());
    assertThat(location.getLatitude()).isEqualTo(locationDTO.getLatitude());
    assertThat(location.getLongitude()).isEqualTo(locationDTO.getLongitude());
    assertThat(location.getType()).isEqualTo(locationDTO.getType());
