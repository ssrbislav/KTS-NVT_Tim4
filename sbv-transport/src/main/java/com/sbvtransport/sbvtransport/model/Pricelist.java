...
public class Pricelist {
  ...
  public Pricelist(Date valid_since, Date valid_until, Boolean active,
      ...
      Double subway_yearly_use_price, Double trolley_one_use_price, Double trolley_daily_use_price,
      Double trolley_monthly_use_price, Double trolley_yearly_use_price) {
